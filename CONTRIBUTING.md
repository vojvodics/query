...
If you have found what you think is a bug, please [file an issue](https://github.com/TanStack/query/issues/new). **PLEASE NOTE:** Issues that are identified as implementation questions or non-issues will be immediately closed and redirected to [Github Discussions](https://github.com/TanStack/query/discussions)
...
- Link `query` locally by running `$ yarn link`
...
- To run examples using your local build, link to the local `query` by running `$ yarn link query` from the example's directory
...
`query` is using [Angular Commit Message Conventions](https://github.com/angular/angular.js/blob/master/DEVELOPERS.md#-git-commit-guidelines).
